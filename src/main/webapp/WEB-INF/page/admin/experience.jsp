                    ...
                    <div class="body table-responsive">
                        ...
                        <c:if test="${not empty experiences}">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                <form method="post" id="remove-form" action="${ctx}/experience/removeAll">
                                    <c:forEach items="${experiences}" var="experience">
                                        <tr>
                                            ...
                                            <td><a href="${experience.company.website}"
                                                   target="_blank">${experience.company.name}</a></td>
                                            <td><fmt:formatDate pattern="yyyy-MM-dd"
                                                                value="${experience.beginDay}"/></td>
...
<script>
    ...
    function edit(json) {
        ...
        for (const k in json) {
            $('#add-form-box [name=' + k + ']').val(json[k])
        }
