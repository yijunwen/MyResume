                        ...
                        <form class="form-validation" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <img class="avatar avatar-195" src="${ctx}/${user.photo}"
                                                             alt="">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="phone" name="phone" maxlength="20"
                                                   class="form-control" placeholder="电话" value="${user.phone}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-9 col-xs-9">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input id="trait" name="trait" maxlength="100" type="text"
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="address" name="address" maxlength="100"
                                                   class="form-control" placeholder="住址" value="${user.address}">
                                        </div>
                                    </div>
                                </div>
                            </div>
