                    ...
                    <div class="body table-responsive">
                        ...
                        <c:if test="${not empty awards}">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                <form id="remove-form" method="post" action="${ctx}/award/removeAll">
                                    <c:forEach items="${awards}" var="award">
                                        <tr>
                                            <td>
                                                <div class="switch">
                                                    <label><input type="checkbox" name="id" value="${award.id}"><span
                                                            class="lever switch-col-blue"></span></label>
                                                </div>
                                            </td>
                                            <td>${award.name}</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-validation" enctype="multipart/form-data" method="post" action="${ctx}/award/save">
...
<script>
    ...
    function edit(json) {
        ...
        /*        $('#add-form-box [name=id]').val(education.id)
                $('#add-form-box [name=name]').val(education.name)
                $('#add-form-box [name=beginDay]').val(education.beginDay)
                $('#add-form-box [name=endDay]').val(education.endDay)
                $('#add-form-box [name=type]').val(education.type)
                $('#add-form-box [name=intro]').val(education.intro)*/
    }
