                    ...
                    <div class="body table-responsive">
                        ...
                        <c:if test="${not empty companies}">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                <form action="${ctx}/company/removeAll" method="post" id="remove-form">
                                    <c:forEach items="${companies}" var="company">
                                        <tr>
                                            <td>
                                                <div class="switch">
                                                    <label><input type="checkbox" name="id" value="${company.id}"><span
                                                            class="lever switch-col-blue"></span></label>
                                                </div>
                                            </td>
                                            <td><a href="${company.website}" target="_blank">${company.name}</a></td>
                                            <td><img src="${ctx}/${company.logo}" alt=""></td>
                                            <td>${company.intro}</td>
                                            <td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-validation" enctype="multipart/form-data" method="post" action="${ctx}/company/save">
...
<script>
    ...
    function edit(json) {
        ...
        if (json.logo) {
            $('#add-img').attr('src', '${ctx}/' + json.logo)
        }
    }
